...
> RAG-powered chatbot for student syllabus queries

Students upload syllabus PDFs and get instant, context-aware AI answers — no more digging through docs.

**Tech:** `Streamlit` `Supabase` `pgvector` `Sentence-Transformers` `Groq LLM` `Hugging Face`

✅ Semantic Search · Vector Embeddings · Streaming Responses · Multi-user Support

[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-FF4B4B?style=flat-square&logo=streamlit)](https://pdfanswermyquestion.streamlit.app/)
[![View Code](https://img.shields.io/badge/View_Code-181717?style=flat-square&logo=github)](https://github.com/rajatsharma)

</td>
<td width="50%" valign="top">

### 📝 AI Answer Sheet Evaluator (HWASE)
> OCR + AI automated grading for handwritten papers

Automatically reads handwritten answer sheets, matches against marking schemes, and generates Excel reports — end-to-end.

**Tech:** `PaddleOCR` `TrOCR` `FastAPI` `FAISS` `Sentence-BERT` `OpenCV` `MySQL`

✅ Handwriting Recognition · Semantic Matching · Batch Evaluation · Teacher Dashboard
...
### 📬 Placement Mail Tracking Agent
> AI-powered email automation for placement tracking

Reads placement emails from Gmail, extracts structured company data using Gemini AI, and syncs everything to a Notion database — fully automated.

**Tech:** `Python` `Gmail API` `Notion API` `Gemini AI` `GitHub Actions` `OAuth 2.0`

✅ Email Parsing · AI Extraction · Auto Database Updates · Duplicate Detection

[![View Code](https://img.shields.io/badge/View_Code-181717?style=flat-square&logo=github)](https://github.com/rajatsharma/outlook-agent-personal)

</td>
<td width="50%" valign="top">

### ⚡ Workflow & Automation Projects
> No-code + AI-powered business automations

A collection of production-grade automations using n8n connecting Gmail, Google Sheets, Webhooks, and AI models to automate real workflows.

**Tech:** `n8n` `Gmail` `Google Sheets` `APIs` `Webhooks` `AI Agents`

✅ Data Processing · Email Automation · Notification Systems · AI Workflows
...
### 🏢 Placement Management Platform *(In Progress)*
> Full-stack platform for centralized placement tracking

A student-facing dashboard to track company applications, deadlines, and outcomes — with WhatsApp + email notifications built in.

**Planned Stack:** `React` `Vite` `FastAPI` `MySQL` `Notion API` `Gmail API` `WhatsApp`

✅ Company Tracking · Application Status · Analytics · Student Dashboard

[![Status](https://img.shields.io/badge/🔨_Building-FFB300?style=flat-square)](https://github.com/rajatsharma)

</td>
<td width="50%" valign="top">

### 🔬 OCR Research & Processing Framework
> Reusable OCR pipeline for scanned + handwritten documents

A modular document processing framework handling deskewing, noise removal, and multi-engine OCR extraction from PDFs and images.

**Tech:** `PaddleOCR` `TrOCR` `OpenCV` `PyMuPDF` `Tesseract` `pdf2image`

✅ Image Preprocessing · Deskewing · Noise Removal · PDF Extraction
...
<img height="180em" src="https://github-readme-stats.vercel.app/api?username=rajatsharma&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&hide_border=true&rank_icon=github" />
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=rajatsharma&layout=compact&langs_count=8&theme=tokyonight&hide_border=true&exclude_repo=github-readme-stats" />

</div>

<div align="center">

<img src="https://github-readme-streak-stats.herokuapp.com/?user=rajatsharma&theme=tokyonight&hide_border=true" width="60%" />

</div>

<div align="center">

<img src="https://github-readme-activity-graph.vercel.app/graph?username=rajatsharma&theme=tokyo-night&hide_border=true&area=true" width="95%" />
...
|  | What | Why It Matters |
|--|------|----------------|
| ☕ | **Spring Boot** — microservices, REST, JPA, security | Industry-standard Java backend; powers half of enterprise SWE roles |
...
Spring Boot      ██████░░░░░░  40%  [ Actively building ]
...
| 🥉 | **Spring Boot proficiency** — REST, JPA, security, microservices at scale | 📖 Learning |
...
<a href="https://linkedin.com/in/rajatsharma">
...
&nbsp;
<a href="https://leetcode.com/rajatsharma">
